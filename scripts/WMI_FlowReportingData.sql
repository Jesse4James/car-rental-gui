...
IF NOT EXISTS (select 1 from sysobjects where type='U' and name='WMI_FlowReportingData')
BEGIN

select @create_query = 
'create table WMI_FlowReportingData
(
	WMI_FlowReportingData_Id numeric(10) Identity PRIMARY KEY,
	Deal_Id numeric(20),
